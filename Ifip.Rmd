...
(ggplot(filter(results,top_position=='1' & views >5), aes(x=reorder(publisherName,-created_posts),y=visibility,fill=Likes))  + facet_wrap(~profileAlign,ncol=2)
...
(ggplot(filter(results,top_position=='30' & occupancy/top > 0.015), aes(x=reorder(publisherName,-created_posts),y=visibility,fill=Likes))  + facet_wrap(~profileAlign,ncol=2)
...
(ggplot(filter(Fairness,top==1, fairnessType=="ProportionalFairness", weight==1), aes(x=reorder(publisherName,-created_posts),y=fairnessOccupancy,fill=Likes))  + facet_wrap(~profileAlign,ncol=2)
...
(ggplot(filter(Fairness,top==1 & weight==2  ), aes(x=reorder(publisherName,-created_posts),y=fairnessOccupancy,colour=fairnessType ,shape=fairnessType))
 +geom_point()
  +theme_bw()+ theme(axis.text.x = element_text(angle = 90, hjust = 1,vjust=0.5),legend.position='bottom',axis.title.x=element_blank(),text = element_text(size=11,face="bold"),legend.direction='horizontal')+labs( y="Occupancy",colour  = "Fairness Type", shape = "Fairness Type")+facet_wrap(~profileAlign,ncol=2))
